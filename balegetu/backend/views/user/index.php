        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            ...
            <?php 
              ...
              echo '<th onclick="orderby(\'user_name\', \'desc\')" '.CommonFun::sortClass($orderby, 'user_name').' tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('user_name').'</th>';
              ...
              echo '<th onclick="orderby(\'user_pwd\', \'desc\')" '.CommonFun::sortClass($orderby, 'user_pwd').' tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('user_pwd').'</th>';
              echo '<th onclick="orderby(\'user_tel\', \'desc\')" '.CommonFun::sortClass($orderby, 'user_tel').' tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('user_tel').'</th>';
            ...
            foreach ($models as $model) {
                ...
                echo '  <td>' . $model->id . '</td>';
                echo '  <td>' . $model->user_name . '</td>';
                echo '  <td>' . $model->sex . '</td>';
                echo '  <td>' . $model->create_data . '</td>';
                echo '  <td>' . $model->user_pwd . '</td>';
                echo '  <td>' . $model->user_tel . '</td>';
	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div id="user_name_div" class="form-group">
              <label for="user_name" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("user_name")?></label>
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="user_name" name="User[user_name]" placeholder="必填" />
              </div>
          ...
          <div id="create_data_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_data" name="User[create_data]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>

          <div id="user_pwd_div" class="form-group">
              <label for="user_pwd" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("user_pwd")?></label>
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="user_pwd" name="User[user_pwd]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>

          <div id="user_tel_div" class="form-group">
              <label for="user_tel" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("user_tel")?></label>
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="user_tel" name="User[user_tel]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_data_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_data" name="User[update_data]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
function orderby(field, op){
 ...
 function initEditSystemModule(data, type){
	...
	if(type == "view"){
      ...
      $("#user_pwd").attr({readonly:true,disabled:true});
      $("#user_tel").attr({readonly:true,disabled:true});
	...
	$('#edit_dialog_ok').addClass('hidden');
      ...
      $("#user_pwd").attr({readonly:false,disabled:false});
      $("#user_tel").attr({readonly:false,disabled:false});
